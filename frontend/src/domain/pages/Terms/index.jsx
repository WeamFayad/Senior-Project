...
function Terms() {
  return (
    <div className="terms-body">
      ...
      <p>Welcome to G3.com!</p>

      <p>
        These terms and conditions outline the rules and regulations for the use
        of G3's Website, located at https://www.G3.com.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use G3.com if you do not agree to take
      ...
      <p>
        ...
        subject to, prevailing law of lb. Any use of the above terminology or
      ...
      <p>
        We employ the use of cookies. By accessing G.com, you agreed to use
        cookies in agreement with the G3's Privacy Policy.{" "}
      </p>
      ...
      <p>
        Unless otherwise stated, G3 and/or its licensors own the intellectual
        property rights for all material on G3.com. All intellectual property
        rights are reserved. You may access this from G3.com for your own
      ...
      <p>You must not:</p>
      <ul>
        <li>Republish material from G3.com</li>
        <li>Sell, rent or sub-license material from G3.com</li>
        <li>Reproduce, duplicate or copy material from G3.com</li>
        <li>Redistribute content from G3.com</li>
      </ul>
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. G3
        ...
        of G3,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, G3 shall not be liable for the Comments
      ...
      <p>
        G3 reserves the right to monitor all Comments and to remove any
      ...
      <p>
        You hereby grant G3 a non-exclusive license to use, reproduce, edit
      ...
      <p>
        ...
        the hyperlink compensates the absence of G3; and (d) the link is in
      ...
      <p>
        ...
        e-mail to G3. Please include your name, your organization name,
      ...
      <p>
        No use of G3's logo or other artwork will be allowed for linking
